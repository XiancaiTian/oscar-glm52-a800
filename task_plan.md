...
- [ ] 当前进行中：2.343已由`62979c1d8d99a8cc7eb2280cd2e1989bd2ae0024`发布；280分钟节点为253/256、93正确、36.758893%当前精度、36.328125%全量精度、0 invalid/129 truncated。仅余3题，理论最好终局96/256，已确定无法达到105/256门禁；26/26 validation、8/8 manifest和报告2.344门禁通过，当前待发布并等待自然终局，继续禁止性能复测。
...
- [ ] ea8 canonical fixed256 v2终局精度门禁与后续32K/batch1性能复测
  ...
  - [ ] 报告2.344待精确提交并通过GitHub HTTPS发布；主实验继续到自然终局。
