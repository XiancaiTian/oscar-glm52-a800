...
- [ ] 当前进行中：2.339已由`77789ce7ac4b894be7c260f6852838fac5d098b9`发布；230分钟节点为227/256、87正确、38.325991%当前精度、33.984375%全量精度、0 invalid/110 truncated。容器、双tmux、TP0–7与c16 runner存活。下一固定节点240分钟。先完成并发布256题终局，达到105/256后再恢复同源码同负载32K/batch1 BF16/OSCAR TTFT、TPOT对比；未达门禁则继续禁止性能复测并先做精度优化。
