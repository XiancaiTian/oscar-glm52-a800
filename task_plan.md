...
- [ ] 当前进行中：2.341已由`0231c0236aaba8f7c03d31a2db3027df4e813e93`发布；260分钟节点为250/256、93正确、37.200000%当前精度、36.328125%全量精度、0 invalid/126 truncated。仅余6题，理论最好终局99/256，已确定无法达到105/256门禁；26/26 validation、8/8 manifest和报告2.342门禁通过，当前待发布并等待自然终局，继续禁止性能复测。
...
- [ ] ea8 canonical fixed256 v2终局精度门禁与后续32K/batch1性能复测
  ...
  - [ ] 报告2.342待精确提交并通过GitHub HTTPS发布；主实验继续到自然终局。
