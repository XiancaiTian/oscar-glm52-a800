...
- [ ] 当前进行中：2.340已由`47be031a60de1cd9900b564e17fa9fff2d47fbe0`发布；250分钟节点为236/256、90正确、38.135593%当前精度、35.156250%全量精度、0 invalid/115 truncated。容器、双tmux、TP0–7与c16 runner存活；26/26 validation、8/8 manifest和报告2.341门禁通过，当前待发布。下一固定节点260分钟。先完成并发布256题终局，达到105/256后再恢复同源码同负载32K/batch1 BF16/OSCAR TTFT、TPOT对比；未达门禁则继续禁止性能复测并先做精度优化。
...
- [ ] ea8 canonical fixed256 v2终局精度门禁与后续32K/batch1性能复测
  ...
  - [ ] 报告2.341待精确提交并通过GitHub HTTPS发布；实验不中断，下一固定节点为260分钟。
