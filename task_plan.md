...
- [ ] 当前进行中：2.339已由`77789ce7ac4b894be7c260f6852838fac5d098b9`发布；240分钟节点为229/256、87正确、37.991266%当前精度、33.984375%全量精度、0 invalid/112 truncated。容器、双tmux、TP0–7与c16 runner存活；26/26 validation、8/8 manifest和报告2.340门禁通过，当前待发布。下一固定节点250分钟。先完成并发布256题终局，达到105/256后再恢复同源码同负载32K/batch1 BF16/OSCAR TTFT、TPOT对比；未达门禁则继续禁止性能复测并先做精度优化。
...
- [ ] ea8 canonical fixed256 v2终局精度门禁与后续32K/batch1性能复测
  ...
  - [ ] 报告2.340待精确提交并通过GitHub HTTPS发布；实验不中断，下一固定节点为250分钟。
