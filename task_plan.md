...
- [ ] 当前进行中：2.341已由`0231c0236aaba8f7c03d31a2db3027df4e813e93`发布；250分钟节点为236/256、90正确、38.135593%当前精度、35.156250%全量精度、0 invalid/115 truncated。容器、双tmux、TP0–7与c16 runner存活。下一固定节点260分钟。先完成并发布256题终局，达到105/256后再恢复同源码同负载32K/batch1 BF16/OSCAR TTFT、TPOT对比；未达门禁则继续禁止性能复测并先做精度优化。
