...
- [ ] 当前进行中：2.342已由`c0d5c1bc518857568bdd55d1e37f9f1e9c4d298d`发布；270分钟节点为252/256、93正确、36.904762%当前精度、36.328125%全量精度、0 invalid/128 truncated。仅余4题，理论最好终局97/256，已确定无法达到105/256门禁；26/26 validation、8/8 manifest和报告2.343门禁通过，当前待发布并等待自然终局，继续禁止性能复测。
...
- [ ] ea8 canonical fixed256 v2终局精度门禁与后续32K/batch1性能复测
  ...
  - [ ] 报告2.343待精确提交并通过GitHub HTTPS发布；主实验继续到自然终局。
