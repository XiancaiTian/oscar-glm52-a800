...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:b247211c9}"
BASE_IMAGE="glm52-oscar-a800-phase6-b247211c9-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="b247211c91cd787149123f0373945e8a0c6c9937"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260731T0440Z_candidate_b247211c9_value_precision_v1/overlay_rootfs/opt/vllm_glm52_v1"
