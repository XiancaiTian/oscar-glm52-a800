...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:c0bcbbbdf}"
BASE_IMAGE="glm52-oscar-a800-phase6-c0bcbbbdf-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="c0bcbbbdfb5ab1d2cafd9096bd3d6556a6ec3264"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260801T062220Z_candidate_c0bcbbbdf_compact_loads_v1/overlay_rootfs/opt/vllm_glm52_v1"
