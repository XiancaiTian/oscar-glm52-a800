...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:98ddd3f4e}"
BASE_IMAGE="glm52-oscar-a800-phase6-98ddd3f4e-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="98ddd3f4ef645bddec76d96cd86a11d17232aaa2"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260730T1928Z_candidate_98ddd3f4e_decode_fastpath/overlay_rootfs/opt/vllm_glm52_v1"
