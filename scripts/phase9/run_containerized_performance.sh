...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:065af88a}"
BASE_IMAGE="glm52-oscar-a800-phase6-065af88a0-0275043c:latest"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260728T112942Z_candidate_065af88a0_v5compat/overlay_rootfs/opt/vllm_glm52_v1"
