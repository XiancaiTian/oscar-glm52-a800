...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:c349e32e9}"
BASE_IMAGE="glm52-oscar-a800-phase6-c349e32e9-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="c349e32e929279e0c7e20676d48d39cc4b5864b3"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260801T0919Z_candidate_c349e32e9_revert_compact_loads_v2/overlay_rootfs/opt/vllm_glm52_v1"
