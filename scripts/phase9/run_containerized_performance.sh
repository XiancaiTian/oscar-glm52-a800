...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:a2fe02055}"
BASE_IMAGE="glm52-oscar-a800-phase6-a2fe02055-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="a2fe0205577b7f4707e9d31213cb5a80eda1f7d4"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260731T0958Z_candidate_a2fe02055_headblock_v1/overlay_rootfs/opt/vllm_glm52_v1"
