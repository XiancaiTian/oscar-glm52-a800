...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:b87a401da}"
BASE_IMAGE="glm52-oscar-a800-phase6-b87a401da-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="b87a401daf55b557b0b052f302fd35be222d1ff1"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260731T0707Z_candidate_b87a401da_8warps_v1/overlay_rootfs/opt/vllm_glm52_v1"
