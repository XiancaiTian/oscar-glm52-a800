...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:1e768aef6}"
BASE_IMAGE="glm52-oscar-a800-phase6-1e768aef6-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="1e768aef6a3916b05f29db0a1fa21a9ad1074712"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260802T1109Z_candidate_1e768aef6_split_topk_v1/overlay_rootfs/opt/vllm_glm52_v1"
