...
CONTROL_IMAGE="${CONTROL_IMAGE:-oscar-glm-stage9-runtime:fd281f5f9}"
BASE_IMAGE="glm52-oscar-a800-phase6-fd281f5f9-0275043c:latest"
BASE_SOURCE_VOLUME="oscar-glm-phase0-source-fd3e0b3"
EXPECTED_SOURCE_COMMIT="fd281f5f974207998a95666d4015c441c5db49ab"
...
prepare_runtime_sources() {
  local overlay_source="${PROJECT_ROOT}/artifacts/phase6/20260731T1235Z_candidate_fd281f5f9_causal_loop_v1/overlay_rootfs/opt/vllm_glm52_v1"
