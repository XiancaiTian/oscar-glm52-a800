...
class BuildCandidateOciTest(unittest.TestCase):
    def test_split_k_stride_fix_source_identity_is_frozen(self) -> None:
        ...
        expected_commit = "ea8ae6b7758ae2b4db7cae44d638ae5de80148ac"
        expected_tree = "8fb091670635eeba3809e4adc02841681b69e8d9"
        self.assertEqual(manifest["source"]["commit"], expected_commit)
        self.assertEqual(manifest["source"]["tree"], expected_tree)
        self.assertEqual(
            manifest["output_tag"],
            "glm52-oscar-a800-phase6-ea8ae6b77-0275043c",
        )
