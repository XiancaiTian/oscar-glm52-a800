...
OVERLAY_ROOTFS="${PROJECT_ROOT}/artifacts/phase6/20260731T0707Z_candidate_b87a401da_8warps_v1/overlay_rootfs"
...
export EXPECTED_SOURCE_COMMIT="${EXPECTED_SOURCE_COMMIT:-b87a401daf55b557b0b052f302fd35be222d1ff1}"
...
export RUNTIME_SOURCE_COMMIT="${RUNTIME_SOURCE_COMMIT:-b87a401daf55b557b0b052f302fd35be222d1ff1}"
export CANDIDATE_MANIFEST_DIGEST="${CANDIDATE_MANIFEST_DIGEST:-sha256:57c03fca6636b9d0ebd97d5d8aecf94b82e872995c76057938738f3e469e484a}"
export CANDIDATE_CONFIG_DIGEST="${CANDIDATE_CONFIG_DIGEST:-sha256:eef27939ae476dd0d727a49ffeaacfcea7c7dfba3311de3146a6cd8feca06eab}"
export CANDIDATE_LAYER_DIGEST="${CANDIDATE_LAYER_DIGEST:-sha256:2ac4b80a9c50ba87db18b41646e5fbf843220e61d8206069b719a7dcf8a2d108}"
