...
- 18:00:15Z 至 23:20:21Z 的 10–330 分钟节点均已写入 `progress_10min.log`；8 张 A800 显存占用约为 79,901–79,939MiB，运行进程持续存活。
- runner 标准输出存在缓冲，进度文件在前三个节点只能记录 `completed unknown/2360`；60/70/80/90/100/110/120/130/140/150/160/170/180/190/200/210/220/230/240/250/260/270/280/290/300/310/320/330 分钟节点分别为 40/40/60/60/80/80/80/100/100/100/120/120/120/140/140/160/160/180/200/220/240/240/260/280/300/300/320/340，不把服务请求数直接当作最终评分数。
- 22:51–22:53Z 服务保持 Running=8、Waiting=0、生成吞吐约 47–52 tokens/s，累计 HTTP 200 为 321，未发现 ERROR、Traceback、CUDA error、OOM 或 timeout；该计数只作为请求完成下界，最终以 `predictions.jsonl` 和 summary 为准。
