...
- 2026-08-04（2.321发布）：主仓`9f106a1bd40b427c42f770ee08cce6783fe3ccf3`已通过GitHub HTTPS发布且local/upstream一致；20:26:55Z容器仍存活，继续等待60分钟固定节点。
- 2026-08-04（v2 60分钟精度/2.322）：20:33:22Z仍为34/256、12正确、35.294118%当前精度、4.687500%全量精度、0 invalid/16 truncated；没有新完成样本。20:34:40Z容器/双tmux/TP0–7/c16 runner存活，8卡76,085 MiB、80%–98%，当前长请求仍在计算；26/26 validation、8/8 manifest通过，报告2.322待门禁发布。
- 2026-08-04（2.322报告门禁）：修改前报告SHA=`218d53c9...33594`且与HEAD一致；追加后18,764行/1,166,454 bytes、SHA=`bae96fde...53176`，2.1–2.322连续且无重复。2.321发布引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过；下一步精确提交并HTTPS发布，实验不中断。
- 2026-08-04（2.322发布）：主仓`cc1c1a426b54ccd55b72853efda6cd9e91597262`已通过GitHub HTTPS发布且local/upstream一致；20:36:59Z容器仍存活，继续等待70分钟固定节点。
- 2026-08-04（v2 70分钟精度/2.323）：20:43:22Z为48/256、16正确、33.333333%当前精度、6.250000%全量精度、0 invalid/26 truncated；相对60分钟新增14题、4题正确、10题新增截断，26个累计截断样本均得分0。20:44:23Z容器/双tmux/TP0–7/c16 runner存活，8卡76,087 MiB、54%–97%；26/26 validation、8/8 manifest通过，报告2.323待门禁发布。
- 2026-08-04（2.323报告门禁）：修改前报告SHA=`bae96fde...53176`且与HEAD一致；追加后18,800行/1,168,770 bytes、SHA=`19a11376...86a40`，2.1–2.323连续且无重复。2.322发布引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过；下一步精确提交并HTTPS发布，实验不中断。
- 2026-08-04（2.323发布）：主仓`c0f07d892359a3d8cdd48ba7c013927294bc20f8`已通过GitHub HTTPS发布且local/upstream一致；20:46:34Z容器仍存活，继续等待80分钟固定节点。
- 2026-08-04（v2 80分钟精度/2.324）：20:53:22Z为67/256、25正确、37.313433%当前精度、9.765625%全量精度、0 invalid/32 truncated；相对70分钟新增19题、9题正确、6题新增截断，32个累计截断样本均得分0。20:53:45Z容器/双tmux/TP0–7/c16 runner存活，8卡76,089 MiB、80%–97%；26/26 validation、8/8 manifest通过，报告2.324待门禁发布。
- 2026-08-04（2.324报告门禁）：修改前报告SHA=`19a11376...86a40`且与HEAD一致；追加后18,836行/1,171,132 bytes、SHA=`f8d72822...08b73`，2.1–2.324连续且无重复。2.323发布引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过；下一步精确提交并HTTPS发布，实验不中断。
- 2026-08-04（2.324发布）：主仓`ffe2bba2286d34224425cc0460521c4d535497ad`已通过GitHub HTTPS发布且local/upstream一致；20:55:59Z容器仍存活，继续等待90分钟固定节点。
- 2026-08-04（v2 90分钟精度/2.325）：21:03:22Z仍为67/256、25正确、37.313433%当前精度、9.765625%全量精度、0 invalid/32 truncated；没有新完成样本。21:04:47Z容器/双tmux/TP0–7/c16 runner存活，8卡76,089 MiB、72%–97%，当前长请求仍在计算；26/26 validation、8/8 manifest通过，报告2.325待门禁发布。
- 2026-08-04（2.325报告门禁）：修改前报告SHA=`f8d72822...08b73`且与HEAD一致；追加后18,870行/1,173,338 bytes、SHA=`73055ba8...b3900`，2.1–2.325连续且无重复。2.324发布引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过；下一步精确提交并HTTPS发布，实验不中断。
- 2026-08-04（2.325发布）：主仓`a84cf0eabccdda14e141c6769438d2b76eb77717`已通过GitHub HTTPS发布且local/upstream一致；21:06:55Z容器仍存活，继续等待100分钟固定节点。
- 2026-08-04（v2 100分钟精度/2.326）：21:13:22Z为77/256、28正确、36.363636%当前精度、10.937500%全量精度、0 invalid/40 truncated；相对90分钟新增10题、3题正确、8题新增截断，40个累计截断样本中有1题评分正确。21:13:48Z容器/双tmux/TP0–7/c16 runner存活，8卡76,091 MiB、60%–97%；26/26 validation、8/8 manifest通过，报告2.326待门禁发布。
- 2026-08-04（2.326报告门禁）：修改前报告SHA=`73055ba8...b3900`且与HEAD一致；追加后18,906行/1,175,740 bytes、SHA=`40f8594a...56126`，2.1–2.326连续且无重复。2.325发布引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过；下一步精确提交并HTTPS发布，实验不中断。
- 2026-08-04（2.326发布）：主仓`1f1af26c6360b434eca6a4f4d4dd648fa46e13a6`已通过GitHub HTTPS发布且local/upstream一致；21:16:02Z容器仍存活，继续等待110分钟固定节点。
- 2026-08-04（v2 110分钟精度/2.327）：21:23:22Z为101/256、40正确、39.603960%当前精度、15.625000%全量精度、0 invalid/48 truncated；相对100分钟新增24题、12题正确、8题新增截断，48个累计截断样本中有2题评分正确。21:24:20Z容器/双tmux/TP0–7/c16 runner存活，8卡76,095 MiB、72%–98%；26/26 validation、8/8 manifest通过，报告2.327待门禁发布。
- 2026-08-04（2.327报告门禁）：修改前报告SHA=`40f8594a...56126`且与HEAD一致；追加后18,942行/1,178,170 bytes、SHA=`4775836e...a8139`，2.1–2.327连续且无重复。2.326发布引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过；下一步精确提交并HTTPS发布，实验不中断。
- 2026-08-04（2.327发布）：主仓`885e460fdbc46943e9df1dd112e2297383adb7d6`已通过GitHub HTTPS发布且local/upstream一致；21:26:36Z容器仍存活，继续等待120分钟固定节点。
- 2026-08-04（v2 120分钟精度/2.328）：21:33:22Z为102/256、41正确、40.196078%当前精度、16.015625%全量精度、0 invalid/48 truncated；相对110分钟新增1题且答对、无新增截断，48个累计截断样本中有2题评分正确。21:34:14Z容器/双tmux/TP0–7/c16 runner存活，8卡76,095 MiB、74%–98%；26/26 validation、8/8 manifest通过，报告2.328待门禁发布。
- 2026-08-04（2.328报告门禁）：追加后报告18,978行/1,180,524 bytes、SHA=`f233f583...af8d0`，2.1–2.328连续且无重复；2.327发布引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。首次表格断言遗漏既有`bytes`单位导致假失败，证据无异常，规则已纠正并记录。下一步精确提交并HTTPS发布，实验不中断。
- 2026-08-04（2.328发布）：主仓`5092197659d445199ccada858f4b29ce7ad4e1ec`已通过GitHub HTTPS发布且local/upstream一致；21:39:03Z容器与双tmux仍存活，继续等待130分钟固定节点。
- 2026-08-04（v2 130分钟精度）：21:43:22Z为111/256、42正确、37.837838%当前精度、16.406250%全量精度、0 invalid/56 truncated；相对120分钟新增9题、1题正确、8题新增截断，56个累计截断样本中仍为2题评分正确。26/26 validation与8/8 manifest通过，下一步完整重读并实时追加报告2.329。
- 2026-08-04（2.329报告门禁）：修改前报告SHA=`f233f583...af8d0`且与HEAD一致；首次追加因通用尾句锚点插到2.320前，提交前已原样移动到2.328末尾。最终19,014行/1,182,970 bytes、SHA=`a7d497a3...36aad`，2.1–2.329连续且无重复；2.328引用、术语、6项核心证据、26/26、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.329发布）：主仓`ae0d1ec8f0ca313a57cc383d7f1de868a1a4e6ed`已通过GitHub HTTPS发布且local/upstream一致；21:48:24Z容器仍存活，继续等待140分钟固定节点。
- 2026-08-04（v2 140分钟精度）：21:53:22Z为133/256、48正确、36.090226%当前精度、18.750000%全量精度、0 invalid/64 truncated；相对130分钟新增22题、6题正确、8题新增截断，64个累计截断样本中仍为2题评分正确。21:54:13Z容器/双tmux/TP0–7/c16 runner存活，8卡76,097 MiB、70%–98%；26/26 validation与8/8 manifest通过，下一步实时追加2.330。
- 2026-08-04（2.330报告门禁）：修改前报告SHA=`a7d497a3...36aad`且与HEAD一致；通过2.329唯一证据行追加后为19,050行/1,185,339 bytes、SHA=`aa7634c2...7a2cd`，2.1–2.330连续且无重复。2.329引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.330发布）：主仓`def16597ff245c9ceee6c8e37671a60ade663300`已通过GitHub HTTPS发布且local/upstream一致；21:56:37Z继续等待150分钟固定节点。
- 2026-08-04（v2 150分钟精度）：22:03:22Z为138/256、52正确、37.681159%当前精度、20.312500%全量精度、0 invalid/64 truncated；相对140分钟新增5题、4题正确、无新增截断，64个累计截断样本中仍为2题评分正确。22:03:54Z容器/双tmux/TP0–7/c16 runner存活，8卡76,099 MiB、76%–97%；26/26 validation与8/8 manifest通过，下一步实时追加2.331。
- 2026-08-04（2.331报告门禁）：修改前报告SHA=`aa7634c2...7a2cd`且与HEAD一致；通过2.330唯一证据行追加后为19,086行/1,187,700 bytes、SHA=`c1ab612c...d48cc`，2.1–2.331连续且无重复。2.330引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.331发布）：主仓`3bb3b77a334064cad1a9b38e3a0129b5e11aa6f8`已通过GitHub HTTPS发布且local/upstream一致；22:06:09Z容器仍存活，继续等待160分钟固定节点。
- 2026-08-04（v2 160分钟精度）：22:13:22Z为144/256、53正确、36.805556%当前精度、20.703125%全量精度、0 invalid/69 truncated；相对150分钟新增6题、1题正确、5题新增截断，69个累计截断样本中仍为2题评分正确。22:13:54Z容器/双tmux/TP0–7/c16 runner存活，8卡76,099 MiB、71%–97%；26/26 validation与8/8 manifest通过，下一步实时追加2.332。
- 2026-08-04（2.332报告门禁）：修改前报告SHA=`c1ab612c...d48cc`且与HEAD一致；通过2.331唯一证据行追加后为19,122行/1,190,069 bytes、SHA=`3f4c2df2...31df7e`，2.1–2.332连续且无重复。2.331引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.332发布）：主仓`62f95b0eebed5470ee895b253a84de5eacb7a923`已通过GitHub HTTPS发布且local/upstream一致；22:16:05Z继续等待170分钟固定节点。
- 2026-08-04（v2 170分钟精度）：22:23:22Z为162/256、60正确、37.037037%当前精度、23.437500%全量精度、0 invalid/78 truncated；相对160分钟新增18题、7题正确、9题新增截断，78个累计截断样本中仍为2题评分正确。22:23:54Z容器/双tmux/TP0–7/c16 runner存活，8卡76,101 MiB、69%–99%；26/26 validation与8/8 manifest通过，下一步实时追加2.333。
- 2026-08-04（2.333报告门禁）：修改前报告SHA=`3f4c2df2...31df7e`且与HEAD一致；通过2.332唯一证据行追加后为19,158行/1,192,441 bytes、SHA=`992ba7a6...a13abf`，2.1–2.333连续且无重复。2.332引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.333发布）：主仓`4f91b00caf5ae9d5b09514aa79b0e1fc565b4023`已通过GitHub HTTPS发布且local/upstream一致；22:26:03Z继续等待180分钟固定节点。
- 2026-08-04（v2 180分钟精度）：22:33:22Z为166/256、62正确、37.349398%当前精度、24.218750%全量精度、0 invalid/80 truncated；相对170分钟新增4题、2题正确、2题新增截断，80个累计截断样本中仍为2题评分正确。22:33:53Z容器/双tmux/TP0–7/c16 runner存活，8卡76,103 MiB、72%–98%；26/26 validation与8/8 manifest通过，下一步实时追加2.334。
- 2026-08-04（2.334报告门禁）：修改前报告SHA=`992ba7a6...a13abf`且与HEAD一致；通过2.333唯一证据行追加后为19,194行/1,194,812 bytes、SHA=`06fbe0bb...74e1a3`，2.1–2.334连续且无重复。2.333引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.334发布）：主仓`ef13ccf6fc279837dffb0151025d6618d37119a0`已通过GitHub HTTPS发布且local/upstream一致；22:36:02Z继续等待190分钟固定节点。
- 2026-08-04（v2 190分钟精度）：22:43:22Z为175/256、67正确、38.285714%当前精度、26.171875%全量精度、0 invalid/84 truncated；相对180分钟新增9题、5题正确、4题新增截断，84个累计截断样本中仍为2题评分正确。22:43:50Z容器/双tmux/TP0–7/c16 runner存活，8卡76,103 MiB、71%–97%；26/26 validation与8/8 manifest通过，下一步实时追加2.335。
- 2026-08-04（2.335报告门禁）：修改前报告SHA=`06fbe0bb...74e1a3`且与HEAD一致；通过2.334唯一证据行追加后为19,230行/1,197,183 bytes、SHA=`b48e64dd...5c36e8`，2.1–2.335连续且无重复。2.334引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.335发布）：主仓`fce323d4752f732b007562417014de5993fd046b`已通过GitHub HTTPS发布且local/upstream一致；22:45:58Z继续等待200分钟固定节点。
- 2026-08-04（v2 200分钟精度）：22:53:22Z为196/256、75正确、38.265306%当前精度、29.296875%全量精度、0 invalid/94 truncated；相对190分钟新增21题、8题正确、10题新增截断，94个累计截断样本中仍为2题评分正确。22:53:52Z容器/双tmux/TP0–7/c16 runner存活，8卡76,105 MiB、72%–97%；26/26 validation与8/8 manifest通过，下一步实时追加2.336。
- 2026-08-04（2.336报告门禁）：修改前报告SHA=`b48e64dd...5c36e8`且与HEAD一致；通过2.335唯一证据行追加后为19,266行/1,199,556 bytes、SHA=`56441db5...31db82`，2.1–2.336连续且无重复。2.335引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.336发布）：主仓`141188e20a7b5c4ca13d7a42d7f02ba2b39d88fb`已通过GitHub HTTPS发布且local/upstream一致；22:55:56Z继续等待210分钟固定节点。
- 2026-08-04（v2 210分钟精度）：23:03:22Z为201/256、77正确、38.308458%当前精度、30.078125%全量精度、0 invalid/96 truncated；相对200分钟新增5题、2题正确、2题新增截断，96个累计截断样本中仍为2题评分正确。23:04:01Z容器/双tmux/TP0–7/c16 runner存活，8卡76,105 MiB、74%–97%；26/26 validation与8/8 manifest通过，下一步实时追加2.337。
- 2026-08-04（2.337报告门禁）：修改前报告SHA=`56441db5...31db82`且与HEAD一致；通过2.336唯一证据行追加后为19,302行/1,201,927 bytes、SHA=`7ac33bd6...ff466b`，2.1–2.337连续且无重复。2.336引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.337发布）：主仓`b4d360a88e7abaf4fd865ffc9eb7cf42c657d1e0`已通过GitHub HTTPS发布且local/upstream一致；23:06:22Z继续等待220分钟固定节点。
- 2026-08-04（v2 220分钟精度）：23:13:22Z为207/256、77正确、37.198068%当前精度、30.078125%全量精度、0 invalid/101 truncated；相对210分钟新增6题、0题正确、5题新增截断，101个累计截断样本中仍为2题评分正确。23:14:03Z容器/双tmux/TP0–7/c16 runner存活，8卡76,107 MiB、瞬时0%；23:10:18Z最近服务快照为76%–98%，不能以单点0%判停。26/26 validation与8/8 manifest通过，下一步实时追加2.338。
- 2026-08-04（2.338报告门禁）：修改前报告SHA=`7ac33bd6...ff466b`且与HEAD一致；通过2.337唯一证据行追加后为19,338行/1,204,364 bytes、SHA=`9bb42642...b48b67d`，2.1–2.338连续且无重复。2.337引用、术语、6项核心证据大小/hash、26/26 validation、8/8 manifest及diff-check全部通过。
- 2026-08-04（2.338发布）：主仓`f9af2615e47f18bee5cae031613120266c65956a`已通过GitHub HTTPS发布且local/upstream一致；23:16:19Z继续等待230分钟固定节点。
- 2026-08-04（230分钟节点）：固定截止`2026-08-03T23:23:22Z`为227/256完成、87正确、38.325991%当前精度、33.984375%全量精度、0 invalid、110 truncated；相对220分钟新增20题完成、10题正确、9个截断样本。运行态采样确认容器、主/修正监控tmux、TP0–7与c16 runner存活，GPU0–7各76,109 MiB且利用率80%–97%；下一步闭合validator/manifest后实时追加报告2.339。
- 2026-08-04（230分钟证据闭合）：逐题复算与监控行完全一致，110个截断样本中4题评分正确；26/26 validation和由六项原始证据、validator、validation JSON组成的8/8 manifest均通过。该阶段只证明中途精度与运行健康，当前87/256尚未达到105/256性能复测门禁。
- 2026-08-04（2.339报告门禁）：正式记录已基于完整重读后的HEAD版本实时追加，当前19,374行、1,206,795 bytes、SHA256=`f431616ea90cff3130fe90bd6ade17175692036151350d01a6399b9ec0565a05`；2.1–2.339连续，术语、2.338发布引用、六项核心证据、26/26 validation、8/8 manifest与diff门禁通过。
- 2026-08-04（2.339发布）：主仓`77789ce7ac4b894be7c260f6852838fac5d098b9`已通过GitHub HTTPS发布且local/upstream一致；主实验继续，下一固定截止为`2026-08-03T23:33:22Z`（14,400秒）。
- 2026-08-04（240分钟节点）：固定截止`2026-08-03T23:33:22Z`为229/256完成、87正确、37.991266%当前精度、33.984375%全量精度、0 invalid、112 truncated；相对230分钟新增2题但无新增正确，新增2个截断样本，累计截断正确仍为4题。运行态健康，26/26 validation与8/8 manifest通过；当前87/256仍未达到105/256性能复测门禁。
- 2026-08-04（2.340报告门禁）：正式记录已基于完整重读后的HEAD版本实时追加，当前19,410行、1,209,219 bytes、SHA256=`6483cc8e2e286deb0a763ca03505d425491590d2ed67d84eee4616cbda05ed22`；2.1–2.340连续，术语、2.339发布引用、六项核心证据、26/26 validation、8/8 manifest与diff门禁通过。
- 2026-08-04（2.340发布）：主仓`47be031a60de1cd9900b564e17fa9fff2d47fbe0`已通过GitHub HTTPS发布且local/upstream一致；主实验继续，下一固定截止为`2026-08-03T23:43:22Z`（15,000秒）。
- 2026-08-04（250分钟节点）：固定截止`2026-08-03T23:43:22Z`为236/256完成、90正确、38.135593%当前精度、35.156250%全量精度、0 invalid、115 truncated；相对240分钟新增7题、3题正确、3个截断，累计截断正确仍为4题。运行态健康，26/26 validation与8/8 manifest通过；当前90/256仍未达到105/256性能复测门禁。
- 2026-08-04（2.341报告门禁）：正式记录已基于完整重读后的HEAD版本实时追加，当前19,446行、1,211,654 bytes、SHA256=`5c80f14479cfbad982797550cceaa830bc71b712545783dad8bef5c4e0bc4983`；2.1–2.341连续，术语、2.340发布引用、六项核心证据、26/26 validation、8/8 manifest与diff门禁通过。
- 2026-08-04（2.341发布）：主仓`0231c0236aaba8f7c03d31a2db3027df4e813e93`已通过GitHub HTTPS发布且local/upstream一致；主实验继续，下一固定截止为`2026-08-03T23:53:22Z`（15,600秒）。
- 2026-08-04（260分钟节点/门禁数学失败）：固定截止`2026-08-03T23:53:22Z`为250/256完成、93正确、37.200000%当前精度、36.328125%全量精度、0 invalid、126 truncated；仅余6题，理论最好终局`93+6=99/256`，严格低于BF16 baseline `105/256`。因此无需等待终局即可确定本候选失去32K/batch1性能复测资格；仍需让实验自然结束并发布终局证据，然后进入canonical精度诊断与优化。
- 2026-08-04（2.342报告门禁）：正式记录已实时追加260分钟门禁确定失败，当前19,485行、1,214,410 bytes、SHA256=`ad5b26dea53441744d0ec6976421f62949049f4583f845390838244ce7756063`；2.1–2.342连续，术语、发布引用、六项核心证据、26/26 validation、8/8 manifest、理论上界与diff门禁通过。
- 2026-08-04（2.342发布）：主仓`c0d5c1bc518857568bdd55d1e37f9f1e9c4d298d`已通过GitHub HTTPS发布且local/upstream一致；当前只等待自然终局证据，不启动32K/batch1性能复测。
- 2026-08-04（270分钟节点）：固定截止`2026-08-04T00:03:22Z`为252/256完成、93正确、36.904762%当前精度、36.328125%全量精度、0 invalid、128 truncated；相对260分钟新增2题但无新增正确。仅余4题，理论最好终局`93+4=97/256`，门禁失败结论进一步收紧；26/26 validation与8/8 manifest通过。
- 2026-08-04（2.343报告门禁）：正式记录已实时追加270分钟节点，当前19,523行、1,217,051 bytes、SHA256=`991af2fc32dc64a749f64006eecdfe29608eff90a237bf79412090598e80f7dc`；2.1–2.343连续，术语、发布引用、六项核心证据、26/26 validation、8/8 manifest、97/256理论上界与diff门禁通过。
- 2026-08-04（2.343发布）：主仓`62979c1d8d99a8cc7eb2280cd2e1989bd2ae0024`已通过GitHub HTTPS发布且local/upstream一致；当前只等待自然终局，若未在下一固定点前结束则继续按10分钟口径记录。
- 2026-08-04（280分钟节点）：固定截止`2026-08-04T00:13:22Z`为253/256完成、93正确、36.758893%当前精度、36.328125%全量精度、0 invalid、129 truncated；相对270分钟新增1题但无新增正确。仅余3题，理论最好终局`93+3=96/256`；26/26 validation与8/8 manifest通过，性能门禁继续关闭。
- 2026-08-04（2.344报告门禁）：正式记录已实时追加280分钟节点，当前19,561行、1,219,725 bytes、SHA256=`bc995c94a84f41cac826c772a9c7c555083fb507a35fc38af236cb907c7d1e3e`；2.1–2.344连续，术语、发布引用、六项核心证据、26/26 validation、8/8 manifest、96/256理论上界与diff门禁通过。
- 2026-08-04（2.344发布）：主仓`50ffdbdefec6a89a651191b7538f8eed7a87c7b5`已通过GitHub HTTPS发布且local/upstream一致；当前只等待自然终局，若未在下一固定点前结束则继续按10分钟口径记录。
...
- 2026-08-04（新一轮CPU-only归因起点）：重新读取2.304–2.305确认，本地仍缺少BF16 SHA=`54a8e8ad...3400`的逐题predictions，因此不能伪造BF16↔当前93/256的逐题翻转；可用的合法配对范围是当前canonical v2与已封存的同256题、同protocol OSCAR历史轮次（ea8 v5 101、c349 K1024 108、K1536 106、K768 97）。2.305此前确认题目ID/prompt hash/gold均可逐题配对；下一步复用原始历史predictions重新计算当前v2的翻转与截断转换。
- 2026-08-04（历史输入定位）：2.305的可复用CPU-only builder给出三份c349原始predictions精确路径与SHA：K1024=`7ac8c847...6cbe`、K1536=`f577a7c6...8ed7`、K768=`c212cfad...4ab`；ea8非canonical v5为`b25f2eb2...6097`。当前canonical v2为`ba5cca74...7bc8`。当前与c349 K1024具有相同K1024/legacy/prefill sort候选口径但source不同，是下一步最接近的配对对照；同时必须量化当前93相对同source非canonical v5 101的反向变化，不能继续把本轮损失简单等同于“截断更多”。
- 2026-08-04（当前↔c349 K1024身份差异精确复核）：两份`parsed_server_args.json`完全同构且均为`index_topk=1024`、seed42、TP8、c16、max_model_len8192等；runtime env除overlay/rotation路径外，唯一算法环境差异是当前ea8显式`VLLM_SPARSE_INDEXER_PREFILL_TOPK_TOKENS=768`，c349 K1024没有该变量。故两者不是完全相同的prefill top-k口径，不能把93↔108的15题差异直接归因于ea8 source。c349→ea8源码差异仅涉及6文件，生产改动集中在`split prefill/decode top-k`、split-K/contiguous输出及相关路径；下一步先读代码确认c349缺省prefill是否实际继承1024，再冻结最小候选。
- 2026-08-04（canonical v2逐题归因结果）：五轮均为同256题、同protocol且ID/prompt hash/gold逐题全匹配。当前93分相对ea8非canonical v5 101分的矩阵为58共同对/35当前独对/43对照独对/120共同错，净-8；相对c349 K1024 108分为62/31/46/117，净-15；相对c349 K1536 106分为60/33/46/117，净-13；相对c349 K768 97分为58/35/39/124，净-4。
- 2026-08-04（截断与因果边界）：当前canonical为132截断，相对ea8非canonical v5反而少8个截断但正确数也少8，故截断总数不能解释精度差；相对c349 K1024多10个截断且少15题，但该对照同时改变source和prefill K=768↔1024，不能单因归责。BF16仍只有105/256聚合门槛，无逐题翻转证据。
...
- 2026-08-04（prefill K1024最小改动面）：活动值由`configs/phase9/performance_matrix.json`统一提供，accuracy入口`run_containerized_performance.sh`与candidate server入口`run_candidate_tp8.sh`均从该配置读取，但各自带fail-closed的三字段硬编码期望；`verify_candidate_performance.py`也冻结同一环境合同。最小production/config范围为这4个文件，只改prefill top-k值；现有`test_phase9_tools.py::test_candidate_runtime_environment_is_wired`可先改期望制造有效红灯，并需增强为同时检查三个消费者不再残留旧768字面量。
- 2026-08-04（prefill K1024绿灯初验）：只把配置与三个fail-closed消费者的prefill top-k从768改为1024，并增强一处合同测试；目标1/1、`test_phase9_tools`完整25/25、Phase9递归90/90、两wrapper `bash -n`及JSON语法均通过。递归测试stdout中的usage/error来自预期负参数用例，最终suite状态为OK；全程固定control容器、network none、GPU不可见。
- 2026-08-04（prefill K1024 CPU证据闭合）：结构化builder首次20/24仅因四项`old_literal in text`期望误写True，测试仍全绿；保留`validation_attempt1.json`后修为False，最终24/24 passed、9/9 manifest外部复算OK。最终目标/工具/递归日志分别1/1、25/25、90/90；核心validation/attempt1/manifest/check SHA=`f2bb381d...3c3c`/`91d06c35...4945`/`cbcfe803...7d67`/`cf2995f4...6a47`。
- 2026-08-04（2.347报告门禁）：修改前报告19,681行/1,228,670 bytes、SHA=`21622e86...0b735`且与HEAD一致；实时追加后为19,757行/1,233,605 bytes、SHA=`38d60dd0...6bacc`。2.1–2.347连续，2.346引用、14项代码/证据大小/hash、24/24 validation、9/9 manifest、术语及diff-check全部通过。
- 2026-08-04（2.347与K1024候选发布）：主仓`90f8d9f1144f298262a1e4bd0fabb80461b688af`已通过GitHub HTTPS发布且local/upstream一致；source仍为`ea8ae6b7758ae2b4db7cae44d638ae5de80148ac`且clean/upstream。GPU实验下一步必须重新取得GPU0–7双空闲门禁。
- 2026-08-04（K1024 fixed256门禁设计）：新授权run ID冻结为`ea8-prefill1024-fast256-v1`，输出根为`/dev/shm/oscar-glm-ea8-prefill1024-fast256-v1`，避免复用canonical v2产物。门禁复用2.315/2.316已验收的userns边界：输出根需宿主用户创建为0777、容器root只写探针成功、正式run目录在启动前不存在；GPU0–7两次采样需显存/利用率全0且compute列表为空，间隔至少60秒。
- 2026-08-04（K1024 GPU门禁v1失败边界）：00:48:18Z/00:49:37Z两轮GPU0–7均0 MiB/0%、compute空，间隔79秒；输出根0777、userns写探针、配置/镜像/source等均通过。但sample1前为实时记录门禁设计而修改了`findings.md`/`progress.md`，故快照中主仓非clean，结构化结果24/25 failed。GPU双空闲事实有效，但正式启动身份门禁未闭合；必须先实时发布该失败边界，再用新run/output身份和新双空闲采样重做，不能修改v1证据后冒充通过。
- 2026-08-04（2.348报告门禁）：修改前报告19,757行/1,233,605 bytes、SHA=`38d60dd0...6bacc`且与HEAD一致；实时追加v1失败边界后为19,807行/1,236,641 bytes、SHA=`7f77a1ed...0534d`。2.1–2.348连续，2.347引用、8项证据大小/hash、24/25唯一main.clean失败、18/18 manifest、术语及diff-check全部通过。
- 2026-08-04（K1024 GPU门禁v2通过）：报告2.348由`ac1feb867b5184b8a56118b4577d993f7d71d3a8`发布并恢复clean/upstream后，v2以全新run/output身份采样；00:53:32Z/00:54:47Z间隔75秒，两轮GPU0–7均0 MiB/0%、compute空。sample1快照确认主/source两仓clean/upstream，输出根0777、userns探针、镜像/config/CPU TDD均通过；25/25 validation、17/17 manifest通过，正式run尚未启动。
- 2026-08-04（2.349报告门禁）：修改前报告19,807行/1,236,641 bytes、SHA=`7f77a1ed...0534d`且与HEAD一致；实时追加v2门禁通过后为19,852行/1,239,588 bytes、SHA=`cf46a6b1...d0425`。2.1–2.349连续，2.348引用、9项证据大小/hash、25/25 validation、17/17 manifest、术语及diff-check全部通过。
- 2026-08-04（K1024 fixed256 v2启动）：2.349已由`c36b5ce15176198c2a537c52502a68f5f96dd87c`发布；00:58:30Z即时8卡全idle后正式启动`ea8-prefill1024-fast256-v2`。容器/主tmux/监控存活，内部双空闲通过，Stage7 static 44/44；runtime env实测legacy/K1024/prefillK1024/sort1，server args为TP8/c16/seed42/index_topk1024。8个TP worker已分配约58.5–61.5 GiB/卡并进入模型加载，无fatal日志。
- 2026-08-04（启动validator首次边界）：首次启动结构化验证31/32，唯一失败是validator误查`network_isolation.txt`包含iproute格式`1: lo:`，实际冻结文件格式为`loopback_ipv4=127.0.0.1/8`且`external_ipv4_probe_exit=7`；网络隔离实际成立。保留失败validation后只修验证器格式期望，不重启实验。此前宿主读取容器root `/proc/.../environ`因shell重定向发生在sudo前而permission denied，随后已由落盘runtime env完整替代。
- 2026-08-04（2.350报告门禁）：修改前报告19,852行/1,239,588 bytes、SHA=`cf46a6b1...d0425`且与HEAD一致；实时追加启动节点后为19,914行/1,243,625 bytes、SHA=`b7b8591a...0bb5d`。2.1–2.350连续，2.349引用、11项证据大小/hash、33/33 validation、18/18 manifest、术语及diff-check全部通过；容器/tmux仍存活。
- 2026-08-04（K1024 v2 10分钟精度）：固定600秒截止01:08:30Z为11/256、10正确、90.909091%当前精度、3.906250%全量精度、0 invalid/0 truncated。22/22 validation、9/9 manifest通过；容器/tmux/c16 runner/TP0–7健康。样本极早，不能外推终局或与105/256门槛直接比较。
- 2026-08-04（2.351报告门禁）：修改前报告19,914行/1,243,625 bytes、SHA=`b7b8591a...0bb5d`且与HEAD一致；实时追加10分钟节点后为19,951行/1,246,065 bytes、SHA=`7f4c74f6...b0cbe`。2.1–2.351连续，2.350引用、7项证据大小/hash、22/22 validation、9/9 manifest、术语及diff-check全部通过；实验存活。
- 2026-08-04（2.351发布）：主仓`b40f4010d2ee797912836fed07c85a65b36726cb`已通过GitHub HTTPS发布且local/upstream一致；实验继续，monitor下一固定节点为1,200秒。
- 2026-08-04（K1024 v2 20分钟精度）：固定1,200秒截止01:18:30Z为17/256、15正确、88.235294%当前精度、5.859375%全量精度、0 invalid/0 truncated；相对10分钟新增6题/5正确。样本仍过早，不能外推终局或宣称达到105/256门槛。
...
- 2026-08-04（K2048 GPU门禁）：新身份`ea8-topk2048-fast256-v1`、输出根`/dev/shm/oscar-glm-ea8-topk2048-fast256-v1`；02:08:19Z/02:09:33Z双空闲间隔74秒，两轮8卡均0 MiB/0%、compute空。候选prefill/index top-k均2048，主/source clean/upstream、固定镜像、0777输出根、容器root写探针、run目录未创建均通过；最终25/25 validation、17/17 manifest，正式run未启动。
- 2026-08-04（K2048 GPU门禁报告）：修改前完整读取统一报告486行/31,469 bytes、SHA=`673185e8...332e`且与HEAD一致；2.15追加门禁后为507行/33,170 bytes、SHA=`91e82621...fc621`。2.1–2.18连续，8项核心证据大小/hash、25/25 validation、17/17 manifest、`三池=0`、`A800=0`、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 fixed256启动）：门禁报告由`fada474641300026d81666ce26f421aa0a60c013`发布后，10:12:29 CST启动`ea8-topk2048-fast256-v1`。外层即时门禁和容器内双空闲均通过；实际CLI/runtime为index/prefill top-k 2048/2048、legacy decode、prefill sort1、TP8、8K、c16。44/44 static通过，8个TP worker已分配GPU并加载模型，无fatal。
- 2026-08-04（K2048启动证据与报告）：启动快照33/33、manifest 17/17，明确formal run已启动但accuracy runner尚未启动。修改前完整读取统一报告507行/33,170 bytes、SHA=`91e82621...fc621`且与HEAD一致；2.15追加后531行/35,103 bytes、SHA=`1eff792f...b3bfb`，2.1–2.18连续，9项证据大小/hash、`三池=0`、`A800=0`、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 10分钟精度）：02:22:29Z固定截止为8/256、6正确、75.000000%当前精度/2.343750%全量精度、0 invalid/0 truncated。服务约02:19才ready，节点仅覆盖约3分钟答题，不能外推终局。截止逐题复算一致，index/prefill top-k 2048/2048，23/23 validation与9/9 manifest通过。
...
- 2026-08-04（隐藏层代理TDD红灯）：新增4个CPU-only合同测试，冻结token级cosine/relative-L2/max-abs计算、基于hook/layer/counter的语义配对、positions一致性和重复identity fail-closed。在固定control镜像、network none、GPU不可见环境中目标suite于import阶段因production `compare_hidden_captures.py`尚不存在而FileNotFoundError退出1；测试先于实现，构成有效缺失功能红灯。
- 2026-08-04（K2048 30分钟精度）：02:42:29Z仍为16/256、11正确、68.750000%当前精度/4.296875%全量精度、0 invalid/0 truncated；8卡同刻均98%，容器/tmux/c16 runner/EngineCore/TP0–7存活且无fatal，确认是长输出批次而非停滞。23/23 validation、9/9 manifest通过。
- 2026-08-04（30分钟报告门禁）：修改前完整读取统一报告574行/38,825 bytes、SHA=`97774c56...3475`；追加后592行/40,429 bytes、SHA=`167103a4...d298`。2.1–2.18连续，8项证据大小/hash、`三池=0`、`A800=0`、交叉引用、whitespace与diff-check通过。
- 2026-08-04（代理比较器绿灯）：离线工具按hook/layer/counter/TP/PP语义identity配对，并对shape/dtype/positions、重复identity、非有限值与零范数fail-closed；输出token级cosine、relative-L2、max-abs、MSE和输入SHA，固定标记`hidden_state_similarity_proxy_unthresholded`、`promotion_gate=false`。aux-runner payload不带layer_idx的真实边界先新增目标测试得到1 error，再从hook严格派生layer后绿灯。
- 2026-08-04（代理CPU证据闭合）：固定control容器目标5/5、Phase9递归95/95、ruff 0.14.0通过；真实`.pt` CLI smoke为1对/2 token，cosine mean 0.9850712500726659、relative-L2 mean 0.14142135307629597，仅验证计算链。结构化验证首轮24/25唯一因`threshold`子串误伤`unthresholded`，保留失败后改为精确禁止`--threshold`，最终25/25、15/15 manifest通过。
...
- 2026-08-04（K2048 140分钟精度）：04:32:29Z仍为102/256完成、45正确、44.117647%当前精度/17.578125%全量精度、0 invalid/48 truncated；较130分钟无新增。8卡98%–100%，容器/tmux/runner/EngineCore/TP0–7均存活，确认是长输出批次而非卡死。23/23 validation与9/9 manifest通过。
- 2026-08-04（140分钟报告门禁）：统一报告追加后975行/72,523 bytes、SHA=`535ab38b...27cb`；2.1–2.19连续，8项节点证据hash、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 150分钟精度）：04:42:29Z为109/256完成、45正确、41.284404%当前精度/17.578125%全量精度、0 invalid/55 truncated；较140分钟新增7题、0题正确、truncated增加7。8卡97%–98%，运行态健康，23/23 validation与9/9 manifest通过。
- 2026-08-04（150分钟报告门禁）：统一报告追加后994行/74,199 bytes、SHA=`f2dda298...3716`；2.1–2.19连续，8项节点证据hash、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 160分钟精度）：04:52:29Z为123/256完成、49正确、39.837398%当前精度/19.140625%全量精度、0 invalid/63 truncated；较150分钟新增14题、4题正确、truncated增加8。8卡均98%，运行态健康，23/23 validation与9/9 manifest通过。
- 2026-08-04（160分钟报告门禁）：统一报告追加后1,013行/75,862 bytes、SHA=`998fd289...b56f`；2.1–2.19连续，8项节点证据hash、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 170分钟精度）：05:02:29Z为124/256完成、49正确、39.516129%当前精度/19.140625%全量精度、0 invalid/64 truncated；较160分钟新增1题、0题正确、truncated增加1。8卡97%–98%，运行态健康，23/23 validation与9/9 manifest通过。
- 2026-08-04（170分钟报告门禁）：统一报告追加后1,032行/77,533 bytes、SHA=`2f277555...7d8a`；2.1–2.19连续，8项节点证据hash、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 180分钟精度）：05:12:29Z为126/256完成、49正确、38.888889%当前精度/19.140625%全量精度、0 invalid/66 truncated；较170分钟新增2题、0题正确、truncated增加2。8卡97%–98%，容器/tmux/runner/EngineCore/TP0–7均存活，23/23 validation与9/9 manifest通过。
- 2026-08-04（180分钟报告门禁）：统一报告追加后1,051行/79,201 bytes、SHA=`a779ce41...010b5`；2.1–2.19连续，8/8节点证据大小/哈希、9/9 manifest、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 190分钟精度）：05:22:29Z为149/256完成、57正确、38.255034%当前精度/22.265625%全量精度、0 invalid/79 truncated；较180分钟新增23题、8题正确、truncated增加13。8卡85%–98%，容器/tmux/runner/EngineCore/TP0–7均存活，23/23 validation与9/9 manifest通过。
- 2026-08-04（190分钟报告门禁）：统一报告追加后1,070行/80,869 bytes、SHA=`ce346530...e7080`；2.1–2.19连续，8/8节点证据大小/哈希、9/9 manifest、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 200分钟精度）：05:32:29Z为155/256完成、62正确、40.000000%当前精度/24.218750%全量精度、0 invalid/80 truncated；较190分钟新增6题、5题正确、truncated增加1。8卡98%–100%，容器/tmux/runner/EngineCore/TP0–7均存活，23/23 validation与9/9 manifest通过。
- 2026-08-04（200分钟报告门禁）：统一报告追加后1,089行/82,536 bytes、SHA=`280a4d60...b55a5`；2.1–2.19连续，8/8节点证据大小/哈希、9/9 manifest、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（K2048 210分钟精度）：05:42:29Z仍为155/256完成、62正确、40.000000%当前精度/24.218750%全量精度、0 invalid/80 truncated；较200分钟无新增。8卡98%–100%，容器/tmux/runner/EngineCore/TP0–7均存活，23/23 validation与9/9 manifest通过，确认为长输出批次而非卡死。
- 2026-08-04（210分钟报告门禁）：统一报告追加后1,108行/84,128 bytes、SHA=`ff43152d...2ef13`；2.1–2.19连续，8/8节点证据大小/哈希、9/9 manifest、术语、交叉引用、whitespace与diff-check通过。
- 2026-08-04（full-attention OSCAR迁移审计定位）：原工程确认位于`/nfs/AE/txc/oscar-glm/oscar_vllm`，其`vllm`与`oscar_reference`分别是两个独立submodule；GLM-5.2迁移工程位于`glm52_oscar_vllm`，远端为`XiancaiTian/glm52_oscar_vllm.git`。下一步需对照原`oscar_vllm/vllm`中full-attention OSCAR backend/dtype/注册入口与GLM-5.2工程实际文件，不能仅根据当前`oscar_mla_int2`的sparse-MLA硬门禁下结论。
- 2026-08-04（原full-attention OSCAR实现确认）：原`oscar_vllm/vllm`确实包含与MLA无关的full-attention OSCAR路径：`CacheDType`注册`oscar_int2`，attention registry注册`OSCAR = ...oscar_attn.OscarAttentionBackend`，实现文件为`vllm/v1/attention/backends/oscar_attn.py`，并有`model_executor/layers/quantization/oscar/`、`triton_oscar_{store,decode,prefill,mixed_store}.py`及`tests/quantization/test_oscar*.py`。因此Shawn指出的“原工程支持full attention模型的OSCAR”有明确源码证据；当前问题必须进一步核对这组文件/注册是否存在于`glm52_oscar_vllm`。
